...
ERPilot MVP'si; doğal dilde (Türkçe) ERP sorgulama, güvenli Text-to-SQL pipeline,
rol bazlı erişim, ERP connector mimarisi (Dolibarr/CSV), anomali tespiti, Excel
karşılaştırma ve günlük özet modüllerini içerir.
...
Sprint 3 sonunda tüm ekibin katıldığı entegrasyon test oturumu. Her modülün
diğerleriyle birlikte doğru çalıştığı doğrulanır.

> P1 sorumluluğu: güvenlik akışı + AI pipeline entegrasyonu.
> Tarih: 2026-07-… (doldur) · Katılımcılar: tüm ekip
...
| Sorun | Etki | Durum |
|-------|------|-------|
| (örnek) … | … | ☐ açık / ☐ giderildi |

### Sonuç

**Genel entegrasyon durumu:** ☐ Başarılı ☐ Kısmi ☐ Bloklu
